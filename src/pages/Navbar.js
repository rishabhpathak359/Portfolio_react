...
const Navbar = () => {
  ...
  <a href='#home'><li className="w-fit mx-10 font-semibold text-lg hover:text-purple-600 pl-4"> 
  <svg className='fill-white pb-2 pl-2' xmlns="http://www.w3.org/2000/svg" width="30" height="28" viewBox="0 0 100 100">
  <path d="M50 8.3L5.5 45.8V90h33.7V63.7h26.6V90H94V45.8L50 8.3zm35 76.7H65V65.3H35v19.7H15V45.8L50 12.3l35 33.5v39.2z"/>
          ...
          <li className="w-fit mx-10 font-semibold text-lg hover:text-purple-600 pl-4">
          <svg className='fill-white pb-2 pl-2' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30">
...
<a href='#skills'><h1 className='relative left-9 bottom-8 '>Skills</h1></a></li>
          <li className="w-fit mx-10 font-semibold text-lg hover:text-purple-600">
          <svg className='fill-white pb-2 pl-2' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30">
...
<a href='#contact'><h1 className='relative left-9 bottom-8 '>Contact</h1></a></li>
  ...
  return (
    ...
    >
      ...
      <div className='z-999'>{renderNavbarContent()}</div>
    </div>
  );
};
